...
int main(int argc, char **argv) {
  ...
  // while (1) {
    ...
    char *argv2_space = strcat(st2," ");
    char *argv23 = strcat(argv2_space, st3);
    char *argv23_space = strcat(argv23, " ");
    char *argv234 = strcat(argv23_space,st4);
...
//this file is modified from var/www/html/google-word2vec-trunk/word-analogy.c